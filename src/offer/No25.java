...
public class No25 {
    public static void findPath(BinaryTreeNode root, int sum) {
        ...
        findPath(root, list, 0, sum);
    }

    private static void findPath(BinaryTreeNode root, List<Integer> list, int current, int sum) {
        if (root != null) {
            current += root.value;
            list.add(root.value);
            ...
            if (current == sum ) {
                ...
                if (root.left != null)
                    findPath(root.left, list, current, sum);
                if (root.right != null)
                    findPath(root.right, list, current, sum);
            }
